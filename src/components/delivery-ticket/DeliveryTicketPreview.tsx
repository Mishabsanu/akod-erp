...
const DeliveryTicketPreview = ({
    ...
    const printStyles = `
        ...
        @media print {
            ...
            .a4-container {
                ...
                left: 2mm !important;
                margin: 0 !important;
                padding: 40px 40px 0 40px !important; /* Increased top padding */
            ...
            * {
            ...
            button, .Action-Bar, .mb-6:not(.a4-container *) {
    ...
    const handleDownload = () => {
        ...
        toast.info('Generating PDF, please wait...', { duration: 2000 });
        ...
        setTimeout(() => {
            const opt = {
                ...
                html2canvas: {
                    ...
                    onclone: (clonedDoc: Document) => {
                        ...
                        // Ensure no extra shadows or transitions affect the capture
                        const container = clonedDoc.querySelector('.a4-container') as HTMLElement;
                        if (container) {
            ...
            try {
                ...
                console.error('html2pdf crash:', err);
                toast.error('Application error during PDF generation.');
                setIsDownloading(false);
            }
        }, 100);
    };
    ...
    return (
        <div className="w-full min-h-screen bg-gray-200 py-4 px-4 flex flex-col items-center print:bg-white print:py-0 print:px-0">
            ...
            <div className="bg-white text-black shadow-2xl w-[210mm] h-[297mm] px-10 pt-10 pb-16 relative print:shadow-none print:w-[210mm] print:h-[297mm] overflow-hidden font-sans text-[10pt] a4-container flex flex-col">
                ...
                {/* 1. Header Section */}
                <div className="flex justify-between items-start mb-3 border-b-2 border-[#0f766e] pb-2">
                    {/* Left: Contact Info */}
                    <div className="w-[35%] text-[7.5pt] text-gray-700 space-y-0 pt-1">
                        <p className="font-bold text-[9pt] mb-0.5 text-[#0f766e]">PROSERVE TRADING & SERVICES WLL</p>
                    ...
                    <div className="w-[30%] flex flex-col items-center">
                        <div className="w-48 h-20 mb-1">
                            <img src="/logo.png" alt="Company Logo" className="w-full h-full object-contain" />
                        </div>
                        <h2 className="text-lg font-black uppercase text-gray-800 tracking-wider underline decoration-2 underline-offset-4 decoration-[#0f766e]">Delivery Note</h2>
                    </div>

                    {/* Right: Address Info */}
                    <div className="w-[35%] text-[7.5pt] text-gray-700 space-y-0 pt-1 text-right">
                        <p>C.R. No: 147701</p>
                        <p>P.O. Box: 9044</p>
                        <p>Building No: 64</p>
                        <p>Street: 3083</p>
                ...
                <div className="border border-gray-400 mb-2 text-sm">
                    ...
                    <div className="flex border-b border-gray-400 items-stretch">
                        ...
                        <div className="w-[50%] border-r border-gray-400 p-1 flex flex-col justify-center items-center text-center bg-[#f0fdfa] relative overflow-hidden">
                            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-teal-600"></div>
                            <p className="text-[#0f766e] mb-1 text-[10px] font-black uppercase tracking-[0.2em] opacity-70">Company Name</p>
                            <p className="font-black uppercase text-xl text-slate-900 leading-none drop-shadow-sm px-4">{data.customerName}</p>
                        </div>

                        {/* Top Right: DN Details */}
                        <div className="w-[50%] text-[10px] flex flex-col">
                            <div className="flex border-b border-gray-400 min-h-[22px] items-stretch">
                                <div className="w-32 p-1 border-r border-gray-400 bg-gray-100 font-bold flex items-center px-2 uppercase text-[8px]">Delivery Note No.</div>
                                <div className="flex-grow p-1 font-black pl-3 text-red-600 text-[12pt] break-words flex items-center">{data.ticketNo}</div>
                            </div>
                            <div className="flex border-b border-gray-400 min-h-[22px] items-stretch">
                                <div className="w-32 p-1 border-r border-gray-400 bg-gray-100 font-bold flex items-center px-2 uppercase text-[8px]">Date</div>
                                <div className="flex-grow p-1 pl-3 font-black text-[10pt] break-words flex items-center">{formatDate(data.deliveryDate)}</div>
                            </div>
                            <div className="flex border-b border-gray-400 min-h-[22px] items-stretch">
                                <div className="w-32 p-1 border-r border-gray-400 bg-gray-100 font-bold flex items-center px-2 uppercase text-[8px]">Invoice Number</div>
                            ...
                            <div className="flex border-b border-gray-400 min-h-[22px] items-stretch">
                                <div className="w-32 p-1 border-r border-gray-400 bg-gray-100 font-bold flex items-center px-2 uppercase text-[8px]">Service Type</div>
                            ...
                            <div className="flex min-h-[22px] items-stretch">
                                <div className="w-32 p-1 bg-gray-100 font-bold flex items-center border-r border-gray-400 px-2 uppercase text-[8px]">LPO NO.</div>
                    ...
                    <div className="flex items-stretch border-b border-gray-400">
                        ...
                        <div className="w-[50%] border-r border-gray-400 flex flex-col">
                            <div className="flex border-b border-gray-400 min-h-[32px] items-stretch flex-1">
                                <div className="w-32 p-1 border-r border-gray-400 bg-gray-100 font-bold flex items-center px-2 uppercase text-[8px]">Delivered From</div>
                            ...
                            <div className="flex min-h-[32px] items-stretch flex-1">
                                <div className="w-32 p-1 border-r border-gray-400 bg-gray-100 font-bold flex items-center px-2 uppercase text-[8px]">Delivery Location</div>
                        ...
                        <div className="w-[50%] text-[10px] flex flex-col">
                            <div className="flex border-b border-gray-400 min-h-[26px] items-stretch">
                ...
                <div className="border border-gray-400 mb-2 min-h-[300px] flex flex-col">
                    <table className="w-full text-xs table-fixed">
                        ...
                        <tbody className="divide-y divide-gray-300">
                            {filledRows.map((item, idx) => (
                                <tr key={idx} className="min-h-10 align-top">
                                    <td className="border-r border-gray-400 text-center text-gray-600 py-2">{idx + 1}</td>
                                    <td className="border-r border-gray-400 px-3 py-2 text-gray-800 uppercase leading-snug">
                                    ...
                                    <td className="border-r border-gray-400 text-center py-2">
                                    ...
                                    <td className="border-r border-gray-400 px-3 py-2 text-gray-700 text-[8.5pt] font-medium normal-case break-words leading-snug">
                                        {item.description || ''}
                                    </td>
                                </tr>
                            ))}
                ...
                <div className="flex justify-between items-center mb-1 px-2 mt-3">
                    <div className="text-[9pt] font-black uppercase text-gray-800 tracking-tight pt-1">Received above items in good condition</div>
                    <div className="text-right text-[8pt] font-bold italic tracking-widest text-gray-400 pt-1">E & O.E</div>
                </div>

                {/* 4. Footer Signatures - PROSERVE Style Dotted */}
                <div className="mt-2 pt-1 pb-1">
                    <div className="flex justify-between items-start gap-16 font-bold text-xs text-gray-800 uppercase tracking-tight">
                        <div className="w-1/2 flex flex-col gap-2">
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">DELIVERED BY:</span>
                                <span className="flex-grow px-2 text-slate-900 font-black">{data.deliveredBy?.deliveredByName || ''}</span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">MOB NO:</span>
                                <span className="flex-grow px-2 font-black">{data.deliveredBy?.deliveredByMobile}</span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">DATE:</span>
                                <span className="flex-grow px-2 font-black">{formatDate(data.deliveredBy?.deliveredDate)}</span>
                            </div>
                            {/* Spacer to match height of Received By (which has QID) */}
                            <div className="flex pb-0.5 items-baseline opacity-0 select-none">
                                <span className="w-28 flex-shrink-0 text-[9px]">SPACER:</span>
                                <span className="flex-grow"></span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline mt-1">
                        ...
                        <div className="w-1/2 flex flex-col gap-2">
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                ...
                                <span className="flex-grow px-2 text-slate-900 font-black truncate">{data.receivedBy?.receivedByName}</span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">MOB NO:</span>
                                <span className="flex-grow px-2 font-black">{data.receivedBy?.receivedByMobile}</span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">DATE:</span>
                                <span className="flex-grow px-2 font-black">{formatDate(data.receivedBy?.receivedDate)}</span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">QID:</span>
                                <span className="flex-grow px-2 font-black">{data.receivedBy?.qatarId || ''}</span>
                            </div>
                            <div className="flex border-b border-dotted border-gray-400 pb-0.5 items-baseline mt-1">
                                <span className="w-28 flex-shrink-0 text-gray-400 text-[9px] font-black uppercase">SIGNATURE:</span>
                                <div className="flex-grow h-4"></div>
                ...
                <div className="absolute bottom-0 left-0 right-0">
                    {/* 5. Bottom Note */}
                    <div className="text-center text-[7pt] text-gray-400 font-bold uppercase tracking-[0.3em] mb-1">
                        This is a Computer Generated Document.
                    </div>
                    <div className="text-center text-white font-sans bg-[#0f766e] py-3 px-10">
                        <div className="flex flex-col gap-1.5 text-[8.5pt] font-bold leading-tight tracking-wide">
                            ...
                            <div className="border-t border-teal-400 pt-2 mt-1 opacity-90 text-[7pt] font-black uppercase tracking-widest flex items-center justify-center gap-6">
