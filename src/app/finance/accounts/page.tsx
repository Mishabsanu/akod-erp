...
export default function FinanceDashboard() {
  ...
  const chartColors = ['#dc2626', '#1e3a8a', '#059669', '#d97706', '#7c3aed', '#db2777'];
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-50 to-white p-6 md:p-10">
      ...
      <div className="flex items-center gap-3 mb-10">
        ...
        <div>
          ...
          <p className="text-gray-500 font-medium">Real-time overview of your company's performance</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all h-full flex flex-col justify-between">
           <div className="flex items-center justify-between mb-4">
              ...
              <div className="p-2.5 bg-red-50 rounded-xl text-red-600 group-hover:scale-110 transition-transform"><TrendingDown size={20} /></div>
           </div>
           <div>
             <p className="text-4xl font-black text-gray-900 tracking-tighter mb-1">
        ...
        <div className="bg-[#111827] p-8 rounded-3xl border border-gray-100 shadow-xl relative overflow-hidden group hover:scale-[1.02] transition-all h-full flex flex-col justify-between">
           <div className="flex items-center justify-between mb-4">
              ...
              <div className="p-2.5 bg-blue-500/10 rounded-xl text-blue-400 group-hover:rotate-12 transition-transform"><DollarSign size={20} /></div>
           </div>
           <div>
        ...
        <div className="lg:col-span-3 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-4 text-xs font-bold uppercase tracking-widest text-gray-400">
              <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-red-600" /> Income</div>
          ...
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data?.monthlyTrends || []}>
                ...
                />
                <Area type="monotone" dataKey="income" stroke="#dc2626" strokeWidth={4} fillOpacity={1} fill="url(#colorIncome)" />
