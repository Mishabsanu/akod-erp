...
const ViewDeliveryTicketPage = () => {
  ...
  // Calculate totals
  const totalProducts = ticket.items.length;
  const totalQuantity = ticket.items.reduce(
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50/50 p-6 md:p-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <SummaryCard label="Total Quantity" value={totalQuantity} />
        <SummaryCard label="Status" value="Delivered" />
        <SummaryCard label="Type" value={ticket.ticketType} />
      </div>
              ...
              <table className="akod-table">
                <thead>
                  <tr>
                    ...
                    <th className="py-3 px-4 text-right font-semibold text-gray-900">Qty</th>
                  </tr>
                </thead>
        ...
        <div className="space-y-6">
          <Section title="Customer Info" className="border-none shadow-sm ring-1 ring-gray-900/5">
            <div className="space-y-4">
              ...
              <Detail label="Delivery Date" value={new Date(ticket.deliveryDate).toLocaleDateString()} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-gray-50 rounded p-3 space-y-2">
                  ...
                  <Detail label="Date" value={new Date(ticket.deliveredBy.deliveredDate).toLocaleDateString()} compact />
                </div>
              </div>
